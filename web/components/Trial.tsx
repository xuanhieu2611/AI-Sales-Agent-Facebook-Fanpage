...
export function Trial() {
  return (
    <section className="border-b border-line bg-brand-soft py-20 sm:py-24">
      <div className="shell">
        <div className="flex flex-col items-start gap-8 md:flex-row md:items-center md:justify-between md:gap-12">
          <div className="flex max-w-[46ch] flex-col gap-4">
            <Eyebrow>Chưa chắc thì học thử</Eyebrow>
            ...
            <p className="text-[1.02rem] leading-relaxed text-ink/70">
              Một buổi học thử thật, lấy nguyên từ lộ trình. Học xong tự kiểm
              tra xem có phân biệt được 12 thì không rồi hẵng quyết định đăng
              ký.
            </p>
          </div>
